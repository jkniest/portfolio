...
<template>
  ...
  >
    ...
    <div class="flex justify-between">
      <div class="rounded-full px-4 py-1 text-xs flex items-center bg-emerald-100" v-text="post.tag" />

      <a class="text-emerald-600 border-b border-emerald-600" @click.prevent="open">Check
        it out</a>
    </div>
  </div>
</template>
